...
// http://stackoverflow.com/questions/21900905/inline-keyword-not-recognized-in-c-module-compiled-inside-a-cpp-project-vs2005
#ifdef _MSC_VER
...
static inline size_t maxz(size_t a, size_t b)
{
    return a > b ? a : b;
}
        ...
        const float * restrict zi_in, float * restrict zo_in)
{
    ...
    int kmin2 = maxi(mini(a, d) - 1, 0);    //start one ahead due to different symmetry in postproc
    int kmax2 = mini(mini(b, c), N / 2);
